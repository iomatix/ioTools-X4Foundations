...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initAutoComplete = () => {
        ...
        if (window.$ && $.fn.autocomplete) {
            ...
            ConsoleStyles.logWarning("jQuery UI autocomplete not found. Skipping initialization.");
        }
    };
    ...
    const transformXML = async () => {
        ...
        try {
            ...
            const scriptType = showMdCheckbox.checked && showAiCheckbox.checked ? "any" :
                               showMdCheckbox.checked ? "md" :
                               showAiCheckbox.checked ? "ai" : "";
            processor.setParameter(null, "scripttype", scriptType);
            processor.setParameter(null, "sort", sortCheckbox.checked ? "true" : "false");
    ...
    const init = async () => {
        ...
        try {
            ...
            if (!xmlDoc || !xslDoc) throw new Error("Failed to load required XML files.");
